...
class SinusGenerator(application: Application) {
    ...
    val buffergroesse: Int = AudioTrack.getMinBufferSize(
        Fs,
    ...
    private fun initTrack() {
        track = AudioTrack.Builder()
            ...
            .setBufferSizeInBytes(buffergroesse)
            .build()
    }
    ...
    private fun playback() {
        // Wave Generator
        val frame_out: ShortArray = ShortArray(buffergroesse)
        var amplitude = 20000
        ...
        while (isPlaying) {
            ...
            for (i in 0 until buffergroesse) {
            ...
            track.write(frame_out, 0, buffergroesse)
        }
    }
    ...
    fun stopPlaying() {
        try {
            ...
            Log.e("AudioTrack", "Stoppen nicht erfolgreich")
        }
    }
}
